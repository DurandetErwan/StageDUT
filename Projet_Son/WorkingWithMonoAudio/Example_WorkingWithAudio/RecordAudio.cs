...
namespace WorkingWithMonoAudio
{
	//
	...
	{
		//static string filePath = "/sdcard/Music/testAudio.mp3"; /data/data/Example_WorkingWithAudio.Example_WorkingWithAudio/files/testAudio.mp4

		static string filePath = "/sdcard/Music/testing.mp4";
